...
docker exec -t temp-ps rm -rf /var/www/html/modules/ps_wirepayment_vorkasse
...
docker run --rm --volumes-from temp-ps \
       -v $PWD:/var/www/html/modules/ps_wirepayment_vorkasse \
       -e _PS_ROOT_DIR_=/var/www/html \
       --workdir=/var/www/html/modules/ps_wirepayment_vorkasse phpstan/phpstan:0.12 \
       analyse \
       --configuration=/var/www/html/modules/ps_wirepayment_vorkasse/tests/phpstan/phpstan-$PS_VERSION.neon
